...
@FacesComponent(value = "svgfaces/1.1/radialGradientComponent")
public class RadialGradientComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "cx");
    writeAttribute(context, "cy");
    writeAttribute(context, "r");
    writeAttribute(context, "fx");
    writeAttribute(context, "fy");
