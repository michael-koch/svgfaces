...
@FacesComponent(value = "svgfaces/1.1/markerComponent")
public class MarkerComponent extends AbstractComponent
{
  ...
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "refX");
    writeAttribute(context, "refY");
    writeAttribute(context, "markerUnits");
    writeAttribute(context, "markerWidth");
    writeAttribute(context, "markerHeight");
    writeAttribute(context, "orient");
  }
