...
@FacesComponent(value = "svgfaces/1.1/feFuncBComponent")
public class FeFuncBComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    writeCoreAttributes(context);
    writeTransferFunctionElementAttributes(context);
  }
