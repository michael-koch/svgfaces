...
@FacesComponent(value = "svgfaces/1.1/altGlyphComponent")
public class AltGlyphComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "glyphRef");
    writeAttribute(context, "format");
