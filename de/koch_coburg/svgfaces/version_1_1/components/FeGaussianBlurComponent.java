...
@FacesComponent(value = "svgfaces/1.1/feGaussianBlurComponent")
public class FeGaussianBlurComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "stdDeviation");
  }
