...
@FacesComponent(value = "svgfaces/1.1/textPathComponent")
public class TextPathComponent extends AbstractComponent
{
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "startOffset");
    writeAttribute(context, "method");
    writeAttribute(context, "spacing");
  }
}