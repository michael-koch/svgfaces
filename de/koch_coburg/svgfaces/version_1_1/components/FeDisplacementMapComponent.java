...
@FacesComponent(value = "svgfaces/1.1/feDisplacementMapComponent")
public class FeDisplacementMapComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "scale");
    writeAttribute(context, "xChannelSelector");
    writeAttribute(context, "yChannelSelector");
  }
