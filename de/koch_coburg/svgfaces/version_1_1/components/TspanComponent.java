...
@FacesComponent(value = "svgfaces/1.1/tspanComponent")
public class TspanComponent extends AbstractComponent
{
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "dx");
    writeAttribute(context, "dy");
    writeAttribute(context, "rotate");
    writeAttribute(context, "textLength");
    writeAttribute(context, "lengthAdjust");
  }
}