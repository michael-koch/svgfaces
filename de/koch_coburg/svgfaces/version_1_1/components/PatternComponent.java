...
@FacesComponent(value = "svgfaces/1.1/patternComponent")
public class PatternComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "patternUnits");
    writeAttribute(context, "patternContentUnits");
    writeAttribute(context, "patternTransform");
  }
