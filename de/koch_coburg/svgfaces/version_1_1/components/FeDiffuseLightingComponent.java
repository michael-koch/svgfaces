...
@FacesComponent(value = "svgfaces/1.1/feDiffuseLightingComponent")
public class FeDiffuseLightingComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "diffuseConstant");
