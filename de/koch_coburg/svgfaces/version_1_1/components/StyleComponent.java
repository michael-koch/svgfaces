...
@FacesComponent(value = "svgfaces/1.1/styleComponent")
public class StyleComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "media");
    writeAttribute(context, "title");
  }
