...
@FacesComponent(value = "svgfaces/1.1/filterComponent")
public class FilterComponent extends AbstractComponent
{
  ...
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "filterRes");
    writeAttribute(context, "filterUnits");
    writeAttribute(context, "primitiveUnits");
  }
