...
@FacesComponent(value = "svgfaces/1.1/maskComponent")
public class MaskComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "maskUnits");
    writeAttribute(context, "maskContentUnits");
  }
