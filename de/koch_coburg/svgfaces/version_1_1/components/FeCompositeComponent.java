...
@FacesComponent(value = "svgfaces/1.1/feCompositeComponent")
public class FeCompositeComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "in2");
    writeAttribute(context, "operator");
    writeAttribute(context, "k1");
    writeAttribute(context, "k2");
    writeAttribute(context, "k3");
    writeAttribute(context, "k4");
  }
