...
@FacesComponent(value = "svgfaces/1.1/colorProfileComponent")
public class ColorProfileComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    ...
    writeAttribute(context, "local");
    writeAttribute(context, "name");
    writeAttribute(context, "rendering-intent");
  }
