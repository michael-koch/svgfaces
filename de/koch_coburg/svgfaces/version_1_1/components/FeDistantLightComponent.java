...
@FacesComponent(value = "svgfaces/1.1/feDistantLightComponent")
public class FeDistantLightComponent extends AbstractComponent
{
  @Override
  protected void writeAttributes(FacesContext context) throws IOException
  {
    writeCoreAttributes(context);
    writeAttribute(context, "azimuth");
    writeAttribute(context, "elevation");
  }
